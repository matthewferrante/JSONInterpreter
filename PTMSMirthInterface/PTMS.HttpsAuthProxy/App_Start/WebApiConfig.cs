...
namespace PTMS.HttpsAuthProxy {
    public static class WebApiConfig {
        public static void Register(HttpConfiguration config) {
            ...
            config.Routes.MapHttpRoute(name: "PracticeApi", routeTemplate: Constants.API_CURRENT_VERSION + "/{practiceId}", defaults: new { controller = "Practice", action = "GetPractice" }, constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get)});
            config.Routes.MapHttpRoute(name: "PracticeMessageApi", routeTemplate: Constants.API_CURRENT_VERSION + "/{practiceId}/File", defaults: new { controller = "Practice", action = "PostFile" }, constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Post) });
